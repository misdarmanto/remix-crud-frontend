  ...
  return (
    <div className=''>
      ...
      <div className='ml-0 md:ml-4 mt-4 md:mt-0 bg-white rounded-xl p-5 sm:p-10 w-full'>
        ...
        <div className='flex gap-5 items-center my-5'>
          <h3 className='text-lg font-semibold'>Nama Referrer : </h3>
          <p className='text-gray-800'>{detailUser.userReferrerName || '_'}</p>
        </div>

        <div className='flex gap-5 items-center my-5'>
          <h3 className='text-lg font-semibold'>Jabatan Referrer : </h3>
